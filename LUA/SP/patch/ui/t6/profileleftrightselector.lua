...
CoD.ProfileLeftRightSelector.getCurrentValue = function (f3_arg0)
	return UIExpression.ProfileValueAsString(f3_arg0.m_currentController, f3_arg0.m_profileVarName)
end

CoD.ProfileLeftRightSelector.new = function (f4_arg0, f4_arg1, f4_arg2, f4_arg3, f4_arg4, f4_arg5)
	local f4_local0 = UIExpression.ProfileValueAsString(f4_arg0, f4_arg2)
	if not f4_arg5 then
	...
	f4_local1.currentProfileVarValue = UIExpression.ProfileValueAsString(f4_arg0, f4_arg2)
