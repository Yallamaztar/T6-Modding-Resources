...
CoD.CoD9Button.AddBackgroundElement = function (f14_arg0, f14_arg1)
	...
	if CoD.isZombie == true then
		CoD9Button.container:addElement(CoD9Button.background)
	end
	f14_arg0.backgroundContainer:addElement(f14_arg0.background)
end

CoD.CoD9Button.new = function (f15_arg0, f15_arg1, f15_arg2)
	local f15_local0 = LUI.UIButton.new(f15_arg0, f15_arg1)
	f15_local0.id = "CoD9Button"
	f15_local0.setLabel = CoD.CoD9Button.SetLabel
	f15_local0.lock = CoD.CoD9Button.Lock
	f15_local0.showNewIcon = CoD.CoD9Button.ShowNewIcon
	f15_local0.showStarIcon = CoD.CoD9Button.ShowStarIcon
	f15_local0.showRestrictedIcon = CoD.CoD9Button.ShowRestrictedIcon
	f15_local0.addBackground = CoD.CoD9Button.AddBackgroundElement
	f15_local0:registerEventHandler("disable_input", CoD.CoD9Button.DisableInput)
	f15_local0:registerEventHandler("enable_input", CoD.CoD9Button.EnableInput)
	f15_local0:registerEventHandler("gain_focus", CoD.CoD9Button.GainFocus)
	f15_local0:registerEventHandler("lose_focus", CoD.CoD9Button.LoseFocus)
	...
	f15_local0:registerAnimationState("pulse_high", {
		alpha = 1
	})
	f15_local0:registerAnimationState("pulse_low", {
		alpha = 0.5
	})
	f15_local0:registerAnimationState("pulse_high_disabled", {
		alpha = f15_local1
	})
	f15_local0:registerAnimationState("pulse_low_disabled", {
		alpha = f15_local2
	})
	f15_local0:registerEventHandler("transition_complete_pulse_high", CoD.CoD9Button.TransitionCompletePulseHigh)
	f15_local0:registerEventHandler("transition_complete_pulse_low", CoD.CoD9Button.TransitionCompletePulseLow)
	f15_local0:registerEventHandler("transition_complete_pulse_high_disabled", CoD.CoD9Button.TransitionCompletePulseHigh)
	f15_local0:registerEventHandler("transition_complete_pulse_low_disabled", CoD.CoD9Button.TransitionCompletePulseLow)
	f15_local0.container = LUI.UIElement.new({
		leftAnchor = true,
		rightAnchor = true,
		left = 0,
		right = 0,
	...
	f15_local0:addElement(f15_local0.container)
	f15_local0.backgroundContainer = LUI.UIElement.new({
		leftAnchor = true,
		rightAnchor = true,
		left = 0,
		right = 0,
	...
	f15_local0:addElement(f15_local0.backgroundContainer)
	if CoD.isZombie == true then
		f15_local0.brackets = CoD.SideBracketsImage.new()
		f15_local0.brackets:setAlpha(0)
		f15_local0.container:addElement(f15_local0.brackets)
	end
	local f15_local3 = LUI.Alignment.Left
	if f15_arg2 then
		f15_local3 = LUI.Alignment.Center
	end
	f15_local0.label = LUI.UIText.new({
		leftAnchor = true,
		rightAnchor = true,
		left = 0,
		right = 0,
	...
	CoD.CoD9Button.SetupTextElement(f15_local0.label)
	f15_local0:addElement(f15_local0.label)
	return f15_local0
end
...
CoD.CoD9Button.RegistrationButtonOver = function (f18_arg0, f18_arg1)
...
CoD.CoD9Button.RegistrationButtonUp = function (f19_arg0, f19_arg1)
	f19_arg0:setRGB(1, 1, 1)
	f19_arg0:setAlpha(0.1)
end

CoD.CoD9Button.RegistrationButtonSetLabel = function (f20_arg0, f20_arg1, f20_arg2, f20_arg3)
	f20_arg0.id = "CoD9RegistrationButton." .. f20_arg1
	f20_arg0.label:setText(f20_arg1)
	f20_arg0.labelString = f20_arg1
	CoD.CoD9Button.SetBracketContainerStates(f20_arg0, f20_arg1, f20_arg2, f20_arg3)
end

CoD.CoD9Button.NewRegistrationButton = function (f21_arg0, f21_arg1, f21_arg2, f21_arg3)
	local f21_local0 = LUI.UIButton.new(f21_arg0, f21_arg1)
	f21_local0.id = "CoD9RegistrationButton"
	f21_local0.setLabel = CoD.CoD9Button.RegistrationButtonSetLabel
	f21_local0.lock = CoD.CoD9Button.Lock
	f21_local0.showNewIcon = CoD.CoD9Button.ShowNewIcon
	f21_local0.showRestrictedIcon = CoD.CoD9Button.ShowRestrictedIcon
	f21_local0.addBackground = CoD.CoD9Button.AddBackgroundElement
	f21_local0:registerEventHandler("disable_input", CoD.CoD9Button.DisableInput)
	f21_local0:registerEventHandler("enable_input", CoD.CoD9Button.EnableInput)
	f21_local0:registerEventHandler("gain_focus", CoD.CoD9Button.GainFocus)
	f21_local0:registerEventHandler("lose_focus", CoD.CoD9Button.LoseFocus)
	local f21_local1 = 0.5
	local f21_local2 = 0.25
	if CoD.isZombie then
		f21_local1 = 1
		f21_local2 = 0.5
	end
	f21_local0:registerAnimationState("pulse_high", {
		alpha = 1
	})
	f21_local0:registerAnimationState("pulse_low", {
		alpha = 0.5
	})
	f21_local0:registerAnimationState("pulse_high_disabled", {
		alpha = f21_local1
	})
	f21_local0:registerAnimationState("pulse_low_disabled", {
		alpha = f21_local2
	})
	f21_local0:registerEventHandler("transition_complete_pulse_high", CoD.CoD9Button.TransitionCompletePulseHigh)
	f21_local0:registerEventHandler("transition_complete_pulse_low", CoD.CoD9Button.TransitionCompletePulseLow)
	f21_local0:registerEventHandler("transition_complete_pulse_high_disabled", CoD.CoD9Button.TransitionCompletePulseHigh)
	f21_local0:registerEventHandler("transition_complete_pulse_low_disabled", CoD.CoD9Button.TransitionCompletePulseLow)
	f21_local0.container = LUI.UIElement.new({
		leftAnchor = true,
		rightAnchor = true,
		left = 0,
		right = 0,
	...
	f21_local0:addElement(f21_local0.container)
	f21_local0.backgroundContainer = LUI.UIElement.new({
		leftAnchor = true,
		rightAnchor = true,
		left = 0,
		right = 0,
	...
	f21_local0:addElement(f21_local0.backgroundContainer)
	if CoD.isZombie == true then
		f21_local0.brackets = CoD.SideBracketsImage.new()
		f21_local0.brackets:setAlpha(0)
		f21_local0.container:addElement(f21_local0.brackets)
	end
	local f21_local3 = LUI.Alignment.Left
	if f21_arg2 then
		f21_local3 = LUI.Alignment.Center
	end
	local f21_local4 = "Condensed"
	local f21_local5 = CoD.CoD9Button.TextHeight
	if f21_arg3 ~= nil then
		f21_local4 = f21_arg3
		f21_local5 = CoD.textSize[f21_local4]
	end
	f21_local0.label = LUI.UIText.new({
		leftAnchor = true,
		rightAnchor = true,
		left = 6,
		right = 0,
		...
		blue = CoD.ButtonTextColor.b,
		alpha = 1,
		font = CoD.fonts[f21_local4],
		alignment = f21_local3
	})
	CoD.CoD9Button.SetupTextElement(f21_local0.label)
	f21_local0:addElement(f21_local0.label)
	f21_local0.border = CoD.Border.new(1, 1, 1, 1, 0.1)
	f21_local0.border:registerEventHandler("button_over", CoD.CoD9Button.RegistrationButtonOver)
	f21_local0.border:registerEventHandler("button_up", CoD.CoD9Button.RegistrationButtonUp)
	f21_local0:addElement(f21_local0.border)
	local f21_local6 = 4
	local f21_local7 = f21_local5 * 2 + 2
	local f21_local8 = LUI.UIImage.new()
	f21_local8:setLeftRight(true, true, f21_local6, -f21_local6)
	f21_local8:setTopBottom(true, false, f21_local6, f21_local7 * 0.6)
	f21_local8:setImage(RegisterMaterial("menu_mp_cac_grad_stretch"))
	f21_local8:setAlpha(0.1)
	f21_local0.backgroundContainer:addElement(f21_local8)
	return f21_local0
end
