...
CoD.LeftRightSelector.HorizontalGap = 300
...
CoD.LeftRightSelector.MouseOnlyAction = function (f14_arg0, f14_arg1)
	if f14_arg0.m_allowCycling ~= false and f14_arg1.mouse then
...
CoD.LeftRightSelector.MouseOnlyActionSecondary = function (f15_arg0, f15_arg1)
	if f15_arg0.m_allowCycling ~= false and f15_arg1.mouse then
...
CoD.LeftRightSelector.new = function (f20_arg0, f20_arg1, f20_arg2, f20_arg3, f20_arg4, f20_arg5)
	...
	if not CoD.isPC then
		...
		f20_local0.leftArrow:registerAnimationState("invisible", {
			alpha = 0
		})
		...
		f20_local0.horizontalList:addSpacer(CoD.LeftRightSelector.ArrowSize)
	end
	...
	if not CoD.isPC then
		...
		f20_local0.rightArrow:registerAnimationState("invisible", {
			alpha = 0
		})
