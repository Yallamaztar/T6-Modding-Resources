...
CoD.ContentGridButton.SetNew = function (f12_arg0, f12_arg1, f12_arg2)
	if not f12_arg1 and f12_arg0.newImage then
		f12_arg0.newImage:close()
		f12_arg0.newImage = nil
		if not CoD.isSinglePlayer and f12_arg2 then
			if f12_arg0.eAttachment and f12_arg0.weaponOption then
				Engine.SetWeaponOptionAsOld(f12_arg2, f12_arg0.eAttachment, f12_arg0.weaponOption)
			elseif f12_arg0.weaponItemIndex and f12_arg0.weaponOption then
				Engine.SetWeaponOptionAsOld(f12_arg2, f12_arg0.weaponItemIndex, f12_arg0.weaponOption)
			elseif f12_arg0.weaponItemIndex and f12_arg0.contentIndex then
				Engine.SetAttachmentAsOld(f12_arg2, f12_arg0.weaponItemIndex, f12_arg0.contentIndex)
			end
		end
		if f12_arg2 and f12_arg0.contentIndex and f12_arg0.itemIsOld == nil then
			Engine.SetItemAsOld(f12_arg2, f12_arg0.contentIndex)
		end
	elseif f12_arg1 and not f12_arg0.newImage then
		f12_arg0.newImage = LUI.UIImage.new()
		local f12_local0 = CoD.CACUtility.ButtonGridNewImageWidth
		local f12_local1 = CoD.CACUtility.ButtonGridNewImageHeight
		if CoD.isSinglePlayer then
			f12_arg0.newImage:setLeftRight(false, true, -f12_local0 - 5, -5)
			f12_arg0.newImage:setTopBottom(true, false, 15, 15 + f12_local1)
		else
			f12_arg0.newImage:setLeftRight(true, false, 10, 10 + f12_local0)
			f12_arg0.newImage:setTopBottom(true, false, 15 - f12_local1 / 2, 15 + f12_local1 / 2)
		end
		f12_arg0.newImage:setImage(RegisterMaterial(CoD.CACUtility.NewImageMaterial))
		f12_arg0:addElement(f12_arg0.newImage)
	end
end

CoD.ContentGridButton.SetRestrictedImage = function (f13_arg0, f13_arg1)
	if f13_arg1 then
		if not f13_arg0.restrictedImage then
			...
			local f13_local0 = -(CoD.ContentGridButton.TitleHeight + 4) / 2
			local f13_local1 = 32
			f13_arg0.restrictedImage = LUI.UIImage.new()
			f13_arg0.restrictedImage:setLeftRight(false, false, -f13_local1 / 2, f13_local1 / 2)
			f13_arg0.restrictedImage:setTopBottom(false, false, f13_local0 - f13_local1 / 2, f13_local0 + f13_local1 / 2)
			f13_arg0.restrictedImage:setPriority(10)
			f13_arg0.restrictedImage:setImage(CoD.GrowingGridButton.RestrictedMaterial)
			f13_arg0:addElement(f13_arg0.restrictedImage)
		end
	elseif f13_arg0.restrictedImage then
		f13_arg0.restrictedImage:close()
		f13_arg0.restrictedImage = nil
	end
end

CoD.ContentGridButton.SetMutuallyExclusive = function (f14_arg0, f14_arg1)
	if f14_arg0.inUseBorder then
		f14_arg0.inUseBorder:close()
		f14_arg0.inUseBorder = nil
	end
	if f14_arg1 then
		if not f14_arg0.mutuallyExclusiveIcon then
			f14_arg0.mutuallyExclusiveIcon = LUI.UIImage.new()
			f14_arg0.mutuallyExclusiveIcon:setLeftRight(true, false, 7, 31)
			f14_arg0.mutuallyExclusiveIcon:setTopBottom(true, false, 15, 39)
			f14_arg0.mutuallyExclusiveIcon:setRGB(CoD.trueOrange.r, CoD.trueOrange.g, CoD.trueOrange.b)
			f14_arg0.mutuallyExclusiveIcon:setImage(RegisterMaterial(CoD.CACUtility.EquipImageMaterial))
			f14_arg0.mutuallyExclusiveIcon:setAlpha(0.5)
			f14_arg0:addElement(f14_arg0.mutuallyExclusiveIcon)
		end
		if not f14_arg0.mutuallyExclusiveIndices then
			f14_arg0.mutuallyExclusiveIndices = {
				f14_arg1
			}
		else
			table.insert(f14_arg0.mutuallyExclusiveIndices, f14_arg1)
		end
	elseif f14_arg0.mutuallyExclusiveIcon then
		f14_arg0.mutuallyExclusiveIndices = nil
		f14_arg0.mutuallyExclusiveIcon:close()
		f14_arg0.mutuallyExclusiveIcon = nil
	end
end

CoD.ContentGridButton.SetInUseFill = function (f15_arg0)
	f15_arg0:setMutuallyExclusive(f15_arg0.contentIndex)
	f15_arg0.glowGradFront:setRGB(CoD.BOIIOrange.r, CoD.BOIIOrange.g, CoD.BOIIOrange.b)
	f15_arg0.glowGradFront:setAlpha(0.2)
	f15_arg0.selectedFill:setAlpha(0.2)
	f15_arg0:setHintText(Engine.Localize("MPUI_ITEM_CURRENTLY_EQUIPPED_IN_ANOTHER_SLOT"))
	f15_arg0.mutuallyExclusiveIcon:close()
end

CoD.ContentGridButton.SetupButtonText = function (f16_arg0, f16_arg1)
	f16_arg0:setBottomTitle(f16_arg1, {
		leftAnchor = true,
		rightAnchor = true,
		left = 5,
		right = 0,
	...
	f16_arg0.nameText = f16_arg1
end

local f0_local0 = function (f17_arg0, f17_arg1)
	f17_arg0:setRGB(CoD.BOIIOrange.r, CoD.BOIIOrange.g, CoD.BOIIOrange.b)
	f17_arg0:setAlpha(1)
	local f17_local0 = f17_arg0:getParent()
	if f17_local0 and (f17_local0.lockImage or f17_local0.isLocked) then
...
CoD.ContentGridButton.SetupButtonImages = function (f19_arg0, f19_arg1, f19_arg2)
	if f19_arg0.grid then
		f19_arg0.grid:close()
	end
	local f19_local0 = LUI.UIImage.new()
	f19_local0:setLeftRight(true, true, 0, 0)
	f19_local0:setTopBottom(true, true, 0, 0)
	f19_local0:setRGB(0, 0, 0)
	f19_local0:setAlpha(0.3)
	f19_local0:setPriority(-110)
	f19_arg0:addElement(f19_local0)
	local f19_local1 = CoD.textSize[CoD.ContentGridButton.FontName] + 4
	local f19_local2 = 1
	local f19_local3 = LUI.UIImage.new()
	f19_local3:setLeftRight(true, true, 2, -2)
	f19_local3:setTopBottom(true, true, 1, -f19_local1 - f19_local2)
	f19_local3:setImage(RegisterMaterial("menu_mp_cac_grad_stretch"))
	f19_local3:setRGB(0, 0, 0)
	f19_local3:setAlpha(1)
	f19_local3:setPriority(-80)
	f19_arg0:addElement(f19_local3)
	if f19_arg1 ~= nil then
		local f19_local4 = 60
		f19_arg0.glowGradBack = LUI.UIImage.new()
		f19_arg0.glowGradBack:setLeftRight(true, true, 1, -1)
		f19_arg0.glowGradBack:setTopBottom(false, true, -f19_local1 - f19_local2 - f19_local4, -f19_local1 - f19_local2)
		f19_arg0.glowGradBack:setImage(RegisterMaterial("menu_mp_cac_grad_stretch_add"))
		f19_arg0.glowGradBack:setRGB(f19_arg1.r, f19_arg1.g, f19_arg1.b)
		f19_arg0.glowGradBack:setAlpha(0.05)
		f19_arg0.glowGradBack:setPriority(-80)
		f19_arg0:addElement(f19_arg0.glowGradBack)
	end
	if f19_arg2 ~= nil then
		local f19_local4 = 30
		f19_arg0.glowGradFront = LUI.UIImage.new()
		f19_arg0.glowGradFront:setLeftRight(true, true, 1, -1)
		f19_arg0.glowGradFront:setTopBottom(false, true, -f19_local1 - f19_local2 - f19_local4, -f19_local1 - f19_local2)
		f19_arg0.glowGradFront:setImage(RegisterMaterial("menu_mp_cac_grad_stretch_add_v2"))
		f19_arg0.glowGradFront:setRGB(f19_arg2.r, f19_arg2.g, f19_arg2.b)
		f19_arg0.glowGradFront:setAlpha(0.05)
		f19_arg0.glowGradFront:setPriority(-80)
		f19_arg0:addElement(f19_arg0.glowGradFront)
	end
	local f19_local4 = LUI.UIImage.new()
	f19_local4:setLeftRight(true, true, 5, -5)
	f19_local4:setTopBottom(true, false, 4, 44)
	f19_local4:setImage(RegisterMaterial("menu_mp_cac_grad_stretch"))
	f19_local4:setPriority(100)
	f19_local4:setAlpha(0.1)
	f19_arg0:addElement(f19_local4)
	local Widget = LUI.UIElement.new()
	Widget:setLeftRight(true, true, 2, -2)
	Widget:setTopBottom(false, true, -f19_local1 - f19_local2, -f19_local2)
	Widget:setPriority(-90)
	f19_arg0:addElement(Widget)
	local f19_local6 = LUI.UIImage.new()
	f19_local6:setLeftRight(true, true, 0, 0)
	f19_local6:setTopBottom(true, true, 0, 0)
	f19_local6:setRGB(0, 0, 0)
	f19_local6:setAlpha(0.8)
	Widget:addElement(f19_local6)
	local f19_local7 = LUI.UIImage.new()
	f19_local7:setLeftRight(true, true, 0, 0)
	f19_local7:setTopBottom(true, false, 0, 12)
	f19_local7:setImage(RegisterMaterial("menu_mp_cac_grad_stretch"))
	f19_local7:setAlpha(0.1)
	Widget:addElement(f19_local7)
	f19_arg0.highlight = CoD.Border.new(1, 1, 1, 1, 0.1)
	f19_arg0.highlight:setPriority(100)
	f19_arg0.highlight:registerAnimationState("default", {
		leftAnchor = true,
		rightAnchor = true,
		left = 0,
		right = 0,
	...
	f19_arg0.highlight:registerEventHandler("button_over", f0_local0)
	f19_arg0.highlight:registerEventHandler("button_up", f0_local1)
	f19_arg0:addElement(f19_arg0.highlight)
	f19_arg0.selectedFill = LUI.UIImage.new()
	f19_arg0.selectedFill:setLeftRight(true, true, 2, -2)
	f19_arg0.selectedFill:setTopBottom(true, true, 1, -1)
	f19_arg0.selectedFill:setRGB(CoD.BOIIOrange.r, CoD.BOIIOrange.g, CoD.BOIIOrange.b)
	f19_arg0.selectedFill:setAlpha(0)
	f19_arg0.selectedFill:setPriority(-110)
	f19_arg0:addElement(f19_arg0.selectedFill)
end

CoD.ContentGridButton.CarouselSetupButtonImages = function (f20_arg0, f20_arg1, f20_arg2, f20_arg3, f20_arg4)
	...
	f20_local0:setRGB(0, 0, 0)
	f20_local0:setAlpha(0.3)
	f20_local0:setPriority(-110)
	f20_arg0:addElement(f20_local0)
	f20_arg0.outline = CoD.Border.new(1, 1, 1, 1, 0.1)
	f20_arg0.outline:setPriority(-100)
	f20_arg0:addElement(f20_arg0.outline)
	local f20_local1 = 1
	local f20_local2 = CoD.textSize[CoD.ContentGridButton.FontName] + 4
	local f20_local3 = CoD.textSize[CoD.ContentGridButton.FontName] + 4
	...
	local f20_local4 = LUI.UIImage.new({
		...
		bottomAnchor = true,
		top = 1,
		bottom = -f20_local2 - f20_local1
	})
	f20_local4:registerAnimationState("button_over", {
		leftAnchor = true,
		rightAnchor = true,
		left = 2,
		right = -2,
		...
		bottomAnchor = true,
		top = 1,
		bottom = -f20_local3 - f20_local1
	})
	f20_local4:setImage(RegisterMaterial("menu_mp_cac_grad_stretch"))
	f20_local4:setRGB(0, 0, 0)
	f20_local4:setAlpha(1)
	f20_local4:setPriority(-80)
	f20_arg0:addElement(f20_local4)
	LUI.UIButton.SetupElement(f20_local4)
	if f20_arg3 ~= nil then
		...
		f20_arg0.glowGradBack = LUI.UIImage.new({
			...
			topAnchor = false,
			bottomAnchor = true,
			top = -f20_local2 - f20_local1 - f20_local5,
			bottom = -f20_local2 - f20_local1
		})
		f20_arg0.glowGradBack:registerAnimationState("button_over", {
			leftAnchor = true,
			rightAnchor = true,
			left = 1,
			right = -1,
	...
	if f20_arg4 ~= nil then
		...
		f20_arg0.glowGradFront:registerAnimationState("button_over", {
			leftAnchor = true,
			rightAnchor = true,
			left = 1,
			right = -1,
		...
		f20_arg0.glowGradFront:setRGB(f20_arg4.r, f20_arg4.g, f20_arg4.b)
		f20_arg0.glowGradFront:setAlpha(0.05)
		f20_arg0.glowGradFront:setPriority(-80)
		f20_arg0:addElement(f20_arg0.glowGradFront)
		LUI.UIButton.SetupElement(f20_arg0.glowGradFront)
	end
	local f20_local5 = LUI.UIImage.new()
	f20_local5:setLeftRight(true, true, 5, -5)
	f20_local5:setTopBottom(true, false, 4, 44)
	f20_local5:setImage(RegisterMaterial("menu_mp_cac_grad_stretch"))
	f20_local5:setPriority(100)
	f20_local5:setAlpha(0.1)
	...
	local Widget = LUI.UIElement.new({
		...
		topAnchor = false,
		bottomAnchor = true,
		top = -f20_local2 - f20_local1,
		bottom = -f20_local1
	})
	Widget:registerAnimationState("button_over", {
		leftAnchor = true,
		rightAnchor = true,
		left = 2,
		right = -2,
		topAnchor = false,
		bottomAnchor = true,
		top = -f20_local3 - f20_local1,
		bottom = -f20_local1
	})
	Widget:setPriority(-90)
	f20_arg0:addElement(Widget)
	LUI.UIButton.SetupElement(Widget)
	local f20_local7 = LUI.UIImage.new()
	f20_local7:setLeftRight(true, true, 0, 0)
	f20_local7:setTopBottom(true, true, 0, 0)
	f20_local7:setRGB(0, 0, 0)
	f20_local7:setAlpha(0.8)
	Widget:addElement(f20_local7)
	local f20_local8 = LUI.UIImage.new()
	f20_local8:setLeftRight(true, true, 0, 0)
	f20_local8:setTopBottom(true, false, 0, 12)
	f20_local8:setImage(RegisterMaterial("menu_mp_cac_grad_stretch"))
	f20_local8:setAlpha(0.1)
	Widget:addElement(f20_local8)
	f20_arg0.highlight = CoD.Border.new(1, CoD.BOIIOrange.r, CoD.BOIIOrange.g, CoD.BOIIOrange.b, 0)
	...
	f20_arg0.highlight:registerAnimationState("button_over", {
		alpha = 1
	})
	LUI.UIButton.SetupElement(f20_arg0.highlight)
