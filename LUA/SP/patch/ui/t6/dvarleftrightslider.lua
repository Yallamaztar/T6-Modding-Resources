...
CoD.DvarLeftRightSlider.new = function (LocalClientIndex, f2_arg1, DvarName, f2_arg3, f2_arg4, f2_arg5, f2_arg6)
	...
	f2_local1.m_dvarName = DvarName
	f2_local1.m_currentValue = f2_local0
	f2_local1.m_currentController = LocalClientIndex
