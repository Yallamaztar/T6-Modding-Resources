...
CoD.InGamePopupMenu.SetupPopup = function (f2_arg0, f2_arg1, f2_arg2, f2_arg3)
	...
	Widget:setLeftRight(false, false, -CoD.InGamePopupMenu.PopupWidth / 2, CoD.InGamePopupMenu.PopupWidth / 2)
	Widget:setTopBottom(false, false, -CoD.InGamePopupMenu.PopupHeight / 2, CoD.InGamePopupMenu.PopupHeight / 2)
	...
	Widget:addElement(buttonList)
	f2_arg0.buttonList = buttonList
	
	f2_arg0.background = Widget
...
CoD.InGamePopupMenu.SetupSavingPopup = function (f3_arg0, f3_arg1)
	...
	Widget:setLeftRight(false, false, -f3_local9 / 2, f3_local9 / 2)
	Widget:setTopBottom(false, true, -CoD.InGamePopupMenu.SavingPopupHeight, 0)
