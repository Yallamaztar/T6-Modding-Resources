...
LUI.UIGridList.UpdateNavigation = function ( self )
	local prevHorizontalList, prevHorizontalListNumChildren, nextHorizontalList, nextHorizontalListNumChildren, currHorizontalList, currHorizontalListNumChildren = nil, nil, nil, nil, nil, nil
