...
LUI.UIAnimNumber.new = function (f1_arg0)
	local f1_local0 = LUI.UIText.new(f1_arg0)
	f1_local0.setNumber = LUI.UIAnimNumber.SetNumber
	f1_local0.setLocalizedString = LUI.UIAnimNumber.SetLocalizedString
	f1_local0.layout = LUI.UIAnimNumber.Layout
	return f1_local0
end
...
LUI.UIAnimNumber.Layout = function (f4_arg0, f4_arg1)
	...
	local f4_local1 = f4_arg0:updateElementLayout(f4_arg1)
	if f4_local1 == 0 then
		f4_local0 = f4_local1
	else
