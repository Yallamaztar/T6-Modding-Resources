...
CoD.ButtonList.new = function (HudRef, CustomButtonSpacing, f27_arg2, CustomHintText)
	if CustomButtonSpacing == nil then
		CustomButtonSpacing = CoD.ButtonList.ButtonSpacing
	end
	local f27_local0 = LUI.UIVerticalList.new(HudRef)
	f27_local0:setSpacing(CustomButtonSpacing)
	...
	if CustomHintText == nil then
		...
		f27_local0.hintText = CustomHintText
	end
