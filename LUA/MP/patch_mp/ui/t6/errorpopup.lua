...
LUI.createMenu.ErrorPopup = function (f3_arg0)
	...
	f3_local4:setLeftRight(true, false, 0, 1)
	f3_local4:setTopBottom(true, false, f3_local3, f3_local3 + CoD.textSize.Big)
	f3_local4:setFont(CoD.fonts.Big)
	f3_local4:setAlignment(LUI.Alignment.Left)
	f3_local2:addElement(f3_local4)
