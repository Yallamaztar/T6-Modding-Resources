...
CoD.CheckClasses.CheckItems = function (f7_arg0, f7_arg1, f7_arg2, f7_arg3, f7_arg4)
	local f7_local0 = {
	...
	local f7_local6 = 63
	local f7_local7 = 78
	for f7_local8 = 0, f7_arg3, 1 do
		local f7_local11 = f7_local3[f7_local8]
		if f7_local11 == nil then
			break
		end
		local f7_local12 = CoD.CheckClasses.GetEquippedBonusCards(f7_arg0, f7_arg2, f7_local8)
		for f7_local24, f7_local25 in pairs(f7_local2) do
			...
			if f7_local16 then
				...
				if not CoD.CheckClasses.IsItemValid(f7_arg1, f7_local17, f7_arg4, f7_local4) then
					local f7_local18 = tonumber(UIExpression.GetDefaultClassSlot(f7_arg1, f7_local0[f7_local8 % 5 + 1], f7_local25))
				...
				elseif f7_local25 == "primary" or f7_local25 == "secondary" then
					if f7_local17 == 0 then
						CoD.CheckClasses.ClearWeapon(f7_local11, f7_local25)
					elseif f7_local5 < f7_local17 then
						local f7_local18 = tonumber(UIExpression.GetDefaultClassSlot(f7_arg1, f7_local0[f7_local8 % 5 + 1], f7_local25))
						if f7_local18 ~= f7_local17 then
							f7_local1 = true
							f7_local16:set(f7_local18)
				...
				elseif f7_local25 == "primarygrenade" or f7_local25 == "specialgrenade" then
					...
					if f7_local17 ~= 0 and (f7_local7 < f7_local17 or f7_local17 < f7_local6) then
